      ...
      <div className="SideMenu">
        ...
        <div className="CategoryList">
          <ul className="NavigationBarMenu" style={{ listStyle: "none" }}>
            <li onClick={(event) => this.props.updateCategory("personal")}>All Tasks</li>
            <li onClick={(event) => this.props.updateCategory("personal")}>Personal</li>
            <li onClick={(event) => this.props.updateCategory("work")}>Work</li>
            <li onClick={(event) => this.props.updateCategory("groceryList")}>Grocery</li>
          </ul>
        </div>
      </div>
    );
